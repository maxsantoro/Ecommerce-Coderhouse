...
export function Login() {
  ...
  return (
    ...
    <div className="w-full max-w-xs m-auto">
      ...
      >
        <div className="mb-4">
          <label htmlFor="email" className="block text-grey-700 text-sm font-bold my-2">Email</label>
          <input
            type="email"
            name="email"
        ...
        <div className="mb-4">
          <label htmlFor="password" className="block text-grey-700 text-sm font-bold my-2">Password</label>
          <input
            type="password"
            name="password"
            id="password"
      ...
      <p className="my-4 text-sm flex justify-between px-3">Don't have an Account ? <Link to='/register'><div className="font-bold">Register</div></Link></p>
